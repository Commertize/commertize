        ...
        <Tabs defaultValue="general" className="w-full">
          ...
          <TabsContent value="trends">
            <div className="space-y-8 p-4">
              {/* Section Header */}
              <div className="mb-8">
                <h2 className="text-2xl font-light text-black mb-2 flex items-center gap-3">
                  <Building className="w-6 h-6" style={{ color: colors.gold }} />
                  CRE Market Trends & Analysis
                </h2>
                <p className="text-sm text-black/60 mb-6">Real-time commercial real estate market intelligence and cap rate tracking</p>
              </div>

              {/* Main Dashboard Grid */}
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                
                {/* Left Column - Cap Rate Analysis */}
                <div className="space-y-6">
                  <SectionHeader 
                  ...
                  {/* Cap Rate Trends */}
                  <Card className="rounded-2xl shadow-lg border-2" style={{ borderColor: colors.gold }}>
                    <CardHeader className="pb-4">
                      <CardTitle className="text-xl font-light text-black flex items-center gap-3 mb-4">
                        Cap Rate Trends - Daily Updates
                        <span className="text-xs bg-[#be8d00] text-white px-3 py-1 rounded-full">Live</span>
                      </CardTitle>
